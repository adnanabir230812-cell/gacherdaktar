...
try {
  ...
  console.log('✅ Maintenance mode enabled locally in maintenance.json');
  ...
  try {
    execSync('git commit -m "chore: enable maintenance mode"', { cwd: repoDir, stdio: 'inherit' });
  } catch (e) {
  ...
  console.log('\n🚀 Success! Maintenance mode has been enabled and pushed to Vercel production!');
} catch (error) {
