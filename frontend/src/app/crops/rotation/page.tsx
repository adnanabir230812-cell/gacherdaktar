...
const ROTATION_DATABASE: RotationPlan[] = [
  ...
  },
  {
    ...
    ideal_followers: [
      { name: "রোপা আমন ধান (খরিপ-২) -> সরিষা/আলু (রবি)", benefits: "পাট কাটার পর আমন ধান রোপণ করলে পাটের ঝরে পড়া পাতা পচে নাইট্রোজেন যোগ করে। আমন কাটার পর সরিষা বা আলু চাষ করলে ৩-ফসলি শস্য পর্যায় সম্পন্ন হয় এবং জমির সর্বোচ্চ ব্যবহার নিশ্চিত হয়।" },
      { name: "গ্রীষ্মকালীন মুগ ডাল -> রোপা আমন ধান", benefits: "পাট কাটার পর মাঠে অবশিষ্ট রসাংশ ব্যবহার করে স্বল্পমেয়াদী ডাল ফসল চাষ করলে মাটির পুষ্টি পুনরুদ্ধার হয় এবং নাইট্রোজেন বৃদ্ধি পায় যা পরবর্তী আমন চাষের জন্য অত্যন্ত উপকারী।" }
    ],
    pest_benefit: "পাটের দ্রুত বৃদ্ধি ও ঘন পাতার কারণে জমিতে ছায়া পড়ে সূর্যালোক পৌঁছায় না, ফলে আগাছা সম্পূর্ণ দমন হয়। এছাড়া আবর্তনে ধান চাষ করলে ধানের ক্ষতিকর মাজরা পোকা ও পাতা মোড়ানো পোকার প্রজনন চক্র ব্যাহত হয়।",
    soil_benefit: "পাটের প্রচুর পাতা ও মূল জমিতে ঝরে পচে বিঘাপ্রতি প্রায় ১.৫ থেকে ২.০ টন উন্নত মানের জৈব সার বা হিউমাস প্রাকৃতিকভাবে মাটিতে যোগ করে, যা মাটির অম্লতা নিয়ন্ত্রণ ও পানি ধারণক্ষমতা বাড়ায়।"
  },
  {
  ...
  },
  {
    ...
    season_bn: "শীতকাল (রবি মৌসুম)",
    ideal_followers: [
      { name: "গ্রীষ্মকালীন মুগ ডাল -> রোপা আমন ধান", benefits: "গম কাটার পর মুগ ডাল চাষ করলে মাটিতে নাইট্রোজেন যুক্ত হয় এবং এরপর রোপা আমন ধান চাষ করলে ইউরিয়া সারের ব্যবহার অনেক কমে ও ধানের উর্বর ফলন হয়।" },
      { name: "তোষা পাট -> রোপা আমন ধান", benefits: "গম তোলার পর তোষা পাট চাষ করলে পাটের পাতা পচে মাটির পুষ্টি পুনরুদ্ধার করে এবং পরবর্তী আমন ধান চাষ অত্যন্ত ফলপ্রসূ হয়।" }
    ],
    pest_benefit: "গমের পর মুগ ডাল বা পাট চাষের ফলে গমের শিকড় পচা ও ব্লাইট (Blight) ছত্রাকের স্পোর আশ্রয়হীন হয়ে ধ্বংস হয় এবং মাটির নিচে ক্ষতিকর কৃমি পোকা (Nematodes) এর বংশবৃদ্ধি রোধ হয়।",
    soil_benefit: "ডাল ফসলের রাইজোবিয়াম ব্যাকটেরিয়া শিকড়ে নডিউল তৈরি করে নাইট্রোজেন ফিক্সেশন করে, যা মাটিতে সারের চাহিদা প্রায় ৩০-৪০% কমিয়ে পরবর্তী আমন ধানের ফলন বাড়ায়।"
  },
  {
    crop_name: "মসুর ডাল",
    season_bn: "শীতকাল (রবি মৌসুম)",
