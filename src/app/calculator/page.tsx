...
function CalculatorContent() {
  ...
  useEffect(() => {
    ...
    setResult({
      urea: Math.round(ureaTotal * 100) / 100,
      tsp: Math.round(tspTotal * 100) / 100,
      mop: Math.round(mopTotal * 100) / 100,
      gypsum: Math.round(gypsumTotal * 100) / 100,
      zinc: Math.round(zincTotal * 100) / 100,
      guidelines
    });
